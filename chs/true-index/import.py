...
p.pk = None
p.code="true-index"
p.name="True index  #arrays"
p.summary="True index"
p.description='''Crea un array de 100 booleans, i estableix els elements en els índexs
indicats a .

**Input Format**

Una sèrie de números enters que representen l'índex dels elements que
han de ser . La sèrie acaba amb un .
