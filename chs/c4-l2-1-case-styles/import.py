...
p.pk = None
p.code="c4-l2-1-case-styles"
p.name="[C5-L2-1] CaSe StYlEs"
p.summary="CaSe StYlEs"
p.description='''Existeixen nombroses convencions a l'hora d'escollir la seqüència de
