...
p.pk = None
p.code="porter-de-discoteca"
p.name="[de165] Porter de discoteca #if"
p.summary="Porter de discoteca"
p.description='''Algunes discoteques tenen unes normes d'accés extranyes. Aquesta en
