...
p.pk = None
p.code="teclado-robot"
p.name="Teclado robot #array"
p.summary="Teclado robot"
p.description='''![image](1613563726-2ffd5674a4-robotkeyboard.jpg)
...
letra  o  según el caso.

Dadas las órdenes de desplazamiento del dedo del robot, indica el texto
que escribirá. La posición inicial del robot es , correspondiente a
la letra .
