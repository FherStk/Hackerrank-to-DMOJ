...
p.pk = None
p.code="operadores-perdidos"
p.name="[C2-L1-3] Operadors perduts #if"
p.summary="Operadors perduts"
p.description='''Donats dos operands i un resultat, troba l'operador que satisfà la
operació.
