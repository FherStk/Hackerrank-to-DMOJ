...
p.pk = None
p.code="cb550-barrel-cannon"
p.name="[cb550] Barrel Cannon #array"
p.summary="Barrel Cannon"
p.description='''En el juego Donkey Kong hay unos "barriles cañón" que disparan al gorila
