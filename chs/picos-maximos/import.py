...
p.pk = None
p.code="picos-maximos"
p.name="Picos máximos"
p.summary="Encontrar los picos máximos en una secuencia de números"
p.description='''Dada una secuencia de valores, el problema consiste en detectar los
