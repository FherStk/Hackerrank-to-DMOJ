...
p.pk = None
p.code="notacio-vectorial"
p.name="Notació arrays  #for"
p.summary="Notació arrays"
p.description='''En Java els arrays es poden inicialitzar amb la següent notació:
...
El tipus de dades de l'entrada sempre és , i l'identificador de
l'array ha de ser .
