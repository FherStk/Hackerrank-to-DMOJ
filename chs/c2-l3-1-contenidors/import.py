...
p.pk = None
p.code="c2-l3-1-contenidors"
p.name="[C2-L3-1] Contenidors #if"
p.summary="Contenidors"
p.description='''Els contenidors són entorns d'execució aïllats que només tenen accés als
