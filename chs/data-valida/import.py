...
p.pk = None
p.code="data-valida"
p.name="[fd2f8] Data vàlida  #operadors"
p.summary="Data vàlida"
p.description='''Una data és vàlida si el número de dia està dintre dels dies del mes.
...
Tres nombres corresponents a una data en format 
